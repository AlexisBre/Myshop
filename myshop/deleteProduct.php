...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <h1 class="col-12">Delete a product</h1>
                <form class="form col-12" role="form" action="deleteProduct.php" method="post">
                   <input type="hidden" name="id" value="<?php echo $id;?>"/>
                   <p class="alert alert-warning">Are you sure you want to delete this product?</p>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-warning">Yes</button>
                        <a class="btn btn-primary" href="products.php">No<a>
                    </div>
                </form>
            </div>
        </div>
